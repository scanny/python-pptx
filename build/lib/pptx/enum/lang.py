...
from .base import (
    EnumMember, ReturnValueOnlyEnumMember, XmlEnumeration,
    XmlMappedEnumMember
)
...
class MSO_LANGUAGE_ID(XmlEnumeration):
    ...
    __members__ = (
        ...
        XmlMappedEnumMember(
            'BOSNIAN_BOSNIA_HERZEGOVINA_CYRILLIC', 8218, 'bs-BA', 'The Bosni'
            'an Bosnia Herzegovina Cyrillic language.'
        ),
        XmlMappedEnumMember(
            'BOSNIAN_BOSNIA_HERZEGOVINA_LATIN', 5146, 'bs-Latn-BA', 'The Bos'
            'nian Bosnia Herzegovina Latin language.'
        ),
        XmlMappedEnumMember(
            'BRAZILIAN_PORTUGUESE', 1046, 'pt-BR', 'The Brazilian Portuguese'
            ' language.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'CHINESE_HONG_KONG_SAR', 3076, 'zh-HK', 'The Chinese Hong Kong S'
            'AR language.'
        ),
        XmlMappedEnumMember(
            'CHINESE_MACAO_SAR', 5124, 'zh-MO', 'The Chinese Macao SAR langu'
            'age.'
        ),
        XmlMappedEnumMember(
            'CHINESE_SINGAPORE', 4100, 'zh-SG', 'The Chinese Singapore langu'
            'age.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'ENGLISH_CANADIAN', 4105, 'en-CA', 'The English Canadian languag'
            'e.'
        ),
        XmlMappedEnumMember(
            'ENGLISH_CARIBBEAN', 9225, 'en-CB', 'The English Caribbean langu'
            'age.'
        ),
        XmlMappedEnumMember(
            'ENGLISH_INDONESIA', 14345, 'en-ID', 'The English Indonesia lang'
            'uage.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'ENGLISH_NEW_ZEALAND', 5129, 'en-NZ', 'The English NewZealand la'
            'nguage.'
        ),
        XmlMappedEnumMember(
            'ENGLISH_PHILIPPINES', 13321, 'en-PH', 'The English Philippines '
            'language.'
        ),
        XmlMappedEnumMember(
            'ENGLISH_SOUTH_AFRICA', 7177, 'en-ZA', 'The English South Africa'
            ' language.'
        ),
        XmlMappedEnumMember(
            'ENGLISH_TRINIDAD_TOBAGO', 11273, 'en-TT', 'The English Trinidad'
            ' Tobago language.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'ENGLISH_ZIMBABWE', 12297, 'en-ZW', 'The English Zimbabwe langua'
            'ge.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'FRANCH_CONGO_DRC', 9228, 'fr-CD', 'The French Congo DRC languag'
            'e.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'FRENCH_COTED_IVOIRE', 12300, 'fr-CI', 'The French Coted Ivoire '
            'language.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'FRENCH_LUXEMBOURG', 5132, 'fr-LU', 'The French Luxembourg langu'
            'age.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'FRENCH_WEST_INDIES', 7180, 'fr-WINDIES', 'The French West Indie'
            's language.'
        ),
        XmlMappedEnumMember(
            'FRISIAN_NETHERLANDS', 1122, 'fy-NL', 'The Frisian Netherlands l'
            'anguage.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'GERMAN_LIECHTENSTEIN', 5127, 'de-LI', 'The German Liechtenstein'
            ' language.'
        ),
        XmlMappedEnumMember(
            'GERMAN_LUXEMBOURG', 4103, 'de-LU', 'The German Luxembourg langu'
            'age.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'KASHMIRI_DEVANAGARI', 2144, 'ks-Deva', 'The Kashmiri Devanagari'
            ' language.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'MACEDONINAN_FYROM', 1071, 'mk-MK', 'The Macedonian FYROM langua'
            'ge.'
        ),
        XmlMappedEnumMember(
            'MALAY_BRUNEI_DARUSSALAM', 2110, 'ms-BN', 'The Malay Brunei Daru'
            'ssalam language.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'NORWEGIAN_BOKMOL', 1044, 'nb-NO', 'The Norwegian Bokmol languag'
            'e.'
        ),
        XmlMappedEnumMember(
            'NORWEGIAN_NYNORSK', 2068, 'nn-NO', 'The Norwegian Nynorsk langu'
            'age.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'ROMANIAN_MOLDOVA', 2072, 'ro-MO', 'The Romanian Moldova languag'
            'e.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'SERBIAN_BOSNIA_HERZEGOVINA_CYRILLIC', 7194, 'sr-BA', 'The Serbi'
            'an Bosnia Herzegovina Cyrillic language.'
        ),
        XmlMappedEnumMember(
            'SERBIAN_BOSNIA_HERZEGOVINA_LATIN', 6170, 'sr-Latn-BA', 'The Ser'
            'bian Bosnia Herzegovina Latin language.'
        ),
        XmlMappedEnumMember(
            'SERBIAN_CYRILLIC', 3098, 'sr-SP', 'The Serbian Cyrillic languag'
            'e.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'SIMPLIFIED_CHINESE', 2052, 'zh-CN', 'The Simplified Chinese lan'
            'guage.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'SINDHI_PAKISTAN', 2137, 'sd-Arab-PK', 'The Sindhi Pakistan lang'
            'uage.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'SPANISH_COLOMBIA', 9226, 'es-CO', 'The Spanish Colombia languag'
            'e.'
        ),
        XmlMappedEnumMember(
            'SPANISH_COSTA_RICA', 5130, 'es-CR', 'The Spanish Costa Rica lan'
            'guage.'
        ),
        XmlMappedEnumMember(
            'SPANISH_DOMINICAN_REPUBLIC', 7178, 'es-DO', 'The Spanish Domini'
            'can Republic language.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'SPANISH_EL_SALVADOR', 17418, 'es-SV', 'The Spanish El Salvador '
            'language.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'SPANISH_HONDURAS', 18442, 'es-HN', 'The Spanish Honduras langua'
            'ge.'
        ),
        XmlMappedEnumMember(
            'SPANISH_MODERN_SORT', 3082, 'es-ES', 'The Spanish Modern Sort l'
            'anguage.'
        ),
        XmlMappedEnumMember(
            'SPANISH_NICARAGUA', 19466, 'es-NI', 'The Spanish Nicaragua lang'
            'uage.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'SPANISH_PARAGUAY', 15370, 'es-PY', 'The Spanish Paraguay langua'
            'ge.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'SPANISH_PUERTO_RICO', 20490, 'es-PR', 'The Spanish Puerto Rico '
            'language.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'SPANISH_VENEZUELA', 8202, 'es-VE', 'The Spanish Venezuela langu'
            'age.'
        ),
        XmlMappedEnumMember(
        ...
        XmlMappedEnumMember(
            'TIGRIGNA_ERITREA', 2163, 'ti-ER', 'The Tigrigna Eritrea languag'
            'e.'
        ),
        XmlMappedEnumMember(
            'TIGRIGNA_ETHIOPIC', 1139, 'ti-ET', 'The Tigrigna Ethiopic langu'
            'age.'
        ),
        XmlMappedEnumMember(
            'TRADITIONAL_CHINESE', 1028, 'zh-TW', 'The Traditional Chinese l'
            'anguage.'
        ),
        XmlMappedEnumMember(
