...
class SlideShapeTree(BaseShapeTree):
    ...
    def add_groupshape(self, left, top, width, height, child_left=0,
            child_top=0, child_width=0, child_height=0):
        """
    ...
    def _add_groupshape_sp(self, x, y, cx, cy, ch_x, ch_y, ch_cx, ch_cy):
        ...
        sp = self._spTree.add_groupshape(id_, name, x, y, cx, cy, ch_x, ch_y,
                ch_cx, ch_cy)
        return sp
