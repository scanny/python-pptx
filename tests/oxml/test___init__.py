...
from pptx.oxml import (
    oxml_parser, parse_xml_bytes, register_custom_element_class
)
...
class DescribeParseXmlBytes(object):
...
def fromstring(request):
    return function_mock(request, 'pptx.oxml.objectify.fromstring')
