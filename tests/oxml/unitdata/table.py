...
class _TestTableElements(object):
    ...
    @property
    def cell(self):
        return parse_xml(test_table_xml.cell)

    @property
    def cell_with_margins(self):
        return parse_xml(test_table_xml.cell_with_margins)

    @property
    def isolated_tbl(self):
        return parse_xml(test_table_xml.isolated_tbl)

    @property
    def isolated_tbl_with_true_props(self):
        return parse_xml(test_table_xml.isolated_tbl_with_true_props)

    @property
    def top_aligned_cell(self):
        return parse_xml(test_table_xml.top_aligned_cell)
