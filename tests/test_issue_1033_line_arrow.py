...
def _restore_part_factory():
    ...
    and ``tests/test_comments.py`` for the rationale.
    """
...
class DescribeIssue1033LineArrow(object):
    ...
    def it_round_trips_an_end_arrow_on_a_LINE_shape(self, _restore_part_factory):
    ...
    def it_round_trips_arrows_on_both_ends_of_a_LINE(self, _restore_part_factory):
